...
namespace Matixs_Mod_Installer.Utilities
{
    [Serializable]
    class SingletonController : MarshalByRefObject
    {
        ...
        {
            m_TCPChannel = new TcpChannel(m_Port);
            ChannelServices.RegisterChannel(m_TCPChannel, false);
            
            RemotingConfiguration.RegisterWellKnownServiceType(
                Type.GetType("Matixs_Mod_Installer.Utilities.SingletonController"),
                "SingletonController",
        ...
        public static void Send(string[] s)
        {
            ...
            try
            {
                ctrl = (SingletonController)Activator.GetObject(typeof(SingletonController), "tcp://localhost:" + m_Port + "/SingletonController");
            }
            catch (Exception e)
            {
